...
/* Here, these both functions are being used to read and write the file inputs and outputs.*/
...
//==============    reading h
    ...
    MPI_Scatterv(dat_glo,counts,offsets,MPI_REAL,dat_loc,nx*my,MPI_REAL,0,MPI_COMM_WORLD);
...
//==============    archiving h
     ...
     MPI_Gatherv (dat_loc,nx*my,MPI_FLOAT,
                  dat_glo,counts,offsets,MPI_FLOAT,0,MPI_COMM_WORLD);
